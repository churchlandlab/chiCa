...
#Quickk fix here, exclude head orientation angles because they are bounded between -1 and 1 (due to sin and cos)
...
#Shuffle all the regressors belonging to one regressor group
