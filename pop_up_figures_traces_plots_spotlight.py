# -*- coding: utf-8 -*-
"""
Created on Mon Oct 28 12:34:52 2024
...
if __name__ == '__main__':
    ...
    def figure_updater(fig_handle, data_axes, lines_on_plots, signal, trialdata, average_interval, window):
        ...
        consider_states = ['DemonWaitForResponse', 'DemonWaitForResponse', 'outcome_presentation', 'outcome_presentation']
        label_states = ['Start center fixation', 'Movement onset', 'Outcome', 'Outcome']
    ...
    def popup(val):
        ...
        state_start_frame, _ = decoding_utils.find_state_start_frame_imaging('DemonWaitForResponse', trialdata, frame_interval, trial_starts)
        aligned_signal, x_vect =  get_state_start_signal(signal, state_start_frame, frame_rate, window)
