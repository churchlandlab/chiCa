...
if __name__ == '__main__':
    ...
    def figure_updater(fig_handle, data_axes, lines_on_plots, signal, trialdata, average_interval, window):
        ...
        for m in range(5):
            ...
            lines_on_plots[15+m] = plot_signal(data_axes[15+m], lines_on_plots[15+m], aligned_signal, x_vect, prior_category, ['Prior right side correct', 'Prior left side correct'])
